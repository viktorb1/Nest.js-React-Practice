import { Body, Controller, Delete, Get, Inject, Param, Post, Put, Req, UseGuards, UseInterceptors } from '@nestjs/common';
...
export class ProductController {
    ...
    async backend(
        ...
        if(request.query.sort == 'asc' || request.query.sort == 'desc') {
            products.sort((a, b) => {
                const sign = Math.abs(a.price - b.price) / (a.price - b.price);
